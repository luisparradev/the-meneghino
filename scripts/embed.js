...
(function(a, k) {
    ...
    q.isXdUrl = function(b) {
        return /^\./.test(b) ? !1 : /^\/\//.test(b) ? !0 : (b = b.match(/^([^\/\:]+\:)\/+([^\/]+)/)) &&
            (b[1] != N || R && b[2] != R)
    };
    ...
    var oa = function(d) {
        ...
        Ca = function(b) {
            ...
            d || (d = function(a, l, p) {
                return Ma(a, l, p, b, d)
            }, b.require = l(d, q), d.module = b, d.toUrl = function(d) {
                return Na(d, b)
        ...
        Ta = function(d, a, l, c, e, g, m, h, y) {
            ...
            b(h, function(b) {
                var a = d.match(b[0]);
                a && 0 <
                a.length && (E = f(b[1]) ? d.replace(b[0], b[1]) : b[1])
            });
        ...
        Y = function(b, d, a) {
            var l, p;
            (l = b.match(/^(.+?)\!(.*)$/)) ?
                (p = Y(l[1], d, a), "sync" != w || p.executed || (ra(p), 2 !== p.injected || p.executed || ka(function() {
                    ja(p)
    ...
    var sa = "function" == typeof a.fixupUrl ? a.fixupUrl : function(b) {
        ...
        Xa = function(b) {
            ...
            d.load ? d.load(b.prid, b.req, a) : d.loadQ ? d.loadQ.push(b) :
    ...
    var Ja = function(b, d, a) {
        ...
        if ((l = e[0] && Y(e[0])) && !T[l.mid]) oa(Ka(l, e[1], e[2]));
            ...
            if (!l)
                for (b in T)
                    if ((c =
                        H[b]) && c.node && "interactive" === c.node.readyState) {
                        l = c;
                        break
                    }
    ...
    if (r.define) A("error", p("defineAlreadyDefined", 0));
    else {
        r.define = Ja;
        r.require = q;
        b(Qa, function(b) {
...
require({
    cache: {
        "dojo/main": function() {
            define("./_base/kernel ./has require ./sniff ./_base/lang ./_base/array ./_base/config ./ready ./_base/declare ./_base/connect ./_base/Deferred ./_base/json ./_base/Color ./has!dojo-firebug?./_firebug/firebug ./_base/browser ./_base/loader".split(" "), function(a, k, h, n, c, e, f, g) {
        ...
        "dojo/has": function() {
            define(["require", "module"], function(a, k) {
                ...
                h.add("pointer-events",
                    "pointerEnabled" in window.navigator ? window.navigator.pointerEnabled : "PointerEvent" in window);
        ...
        "dojo/sniff": function() {
            define(["./has"], function(a) {
                ...
                a("webkit") || (0 <= h.indexOf("Opera") && a.add("opera", 9.8 <= n ? parseFloat(h.split("Version/")[1]) ||
        ...
        "dojo/_base/lang": function() {
            define(["./kernel", "../has", "../sniff"], function(a, k) {
                ...
                var h = k("bug-for-in-skips-shadowed") ? "hasOwnProperty valueOf isPrototypeOf propertyIsEnumerable toLocaleString toString constructor".split(" ") : [],
                    ...
                    f = function(b, a, p) {
                        return (p || []).concat(Array.prototype.slice.call(b,
                            a || 0))
                    },
                    g = /\{([^\}]+)\}/g,
                    m = {
                        ...
                        isArrayLike: function(b) {
                            return b && void 0 !== b && !m.isString(b) && !m.isFunction(b) && !(b.tagName && "form" ==
                                b.tagName.toLowerCase()) && (m.isArray(b) || isFinite(b.length))
                        },
                        isAlien: function(b) {
                        ...
                        hitch: function(b, l) {
                            if (2 < arguments.length) return m._hitchArgs.apply(a,
                                arguments);
                            l || (l = b, b = null);
                            if (m.isString(l)) {
                                b = b || a.global;
        ...
        "dojo/_base/array": function() {
            define(["./kernel", "../has", "./lang"], function(a, k, h) {
                function n(b) {
        ...
        "dojo/ready": function() {
            define(["./_base/kernel", "./has", "require", "./domReady", "./_base/lang"], function(a, k, h, n, c) {
                var e = 0,
                    f = [],
                    g = 0;
                k = function() {
            ...
            define(["./has"], function(a) {
                ...
                if (!g) {
                    var l = [],
                        p = function(b) {
                            b = b || n.event;
                            g || "readystatechange" == b.type &&
                            !e[c.readyState] || (f && (c.readyState = "complete"), g = 1, h())
                        },
                        d = function(b, d) {
        ...
        "dojo/_base/declare": function() {
            define(["./kernel", "../has", "./lang"], function(a, k, h) {
                ...
                function c(b, d, a) {
                    ...
                    if ("constructor" != c) {
                        if (h.c !== g && (m = 0, f = l[0], p = f._meta, p.hidden[c] !== g)) {
                            ...
                            do
                                if (p = f._meta, e = f.prototype, p && (e[c] === g && e.hasOwnProperty(c) || p.hidden[c] === g)) break;
                            while (f = l[++m]);
                            m = f ? m : -1
                        }
                        if (f = l[++m])
                            if (e = f.prototype, f._meta && e.hasOwnProperty(c)) a = e[c];
                                ...
                                g = u[c];
                                do
                                    if (e = f.prototype, (a = e[c]) && (f._meta ? e.hasOwnProperty(c) : a !== g)) break;
                                while (f = l[++m])
                            }
                        a = f && a || u[c]
                    } else {
                        if (h.c !== g && (m =
                            0, (p = l[0]._meta) && p.ctor !== g)) {
                ...
                function g(b) {
                    for (var d = this.constructor._meta.bases,
                             a = 0, c = d.length; a < c; ++a)
                        if (d[a] === b) return !0;
                ...
                a.safeMixin = x.safeMixin = function(b, d) {
                    ...
                    if (k("bug-for-in-skips-shadowed"))
                        for (var e = h._extraNames, l = e.length; l;) a = e[--l], c = d[a], c === u[a] && a in u || "constructor" == a || ("[object Function]" ==
                        z.call(c) && (c.nom = a), b[a] = c);
                    return b
                };
                return a.declare = x
            })
        ...
        "dojo/_base/connect": function() {
            define("./kernel ../on ../topic ../aspect ./event ../mouse ./sniff ./lang ../keys".split(" "), function(a, k, h, n, c, e, f, g) {
        ...
        "dojo/on": function() {
            define(["./has!dom-addeventlistener?:./aspect", "./_base/kernel", "./sniff"], function(a, k, h) {
                ...
                h.add("event-stopimmediatepropagation", window.Event && !!window.Event.prototype &&
                ...
                if (h("dom-addeventlistener")) g.emit =
                    function(b, d, a) {
                    ...
                    g._fixEvent = function(b, d) {
                        ...
                        if (!b.target) switch (b.target = b.srcElement, b.currentTarget = d || b.srcElement,
                        "mouseover" == b.type && (b.relatedTarget = b.fromElement), "mouseout" == b.type && (b.relatedTarget = b.toElement), b.stopPropagation || (b.stopPropagation = v, b.preventDefault = u), b.type) {
                            case "keypress":
                    ...
                    function a(a, c, b, e) {
                        ...
                        if (f && !d)
                            if ("after" == c) {
                                ...
                                f.next = h;
                                h.previous = f
                            } else "before" == c && (a[c] = h, h.next = f, f.previous =
                                h);
                        else a[c] = h;
                        return h
                    }
        ...
        "dojo/_base/event": function() {
            define(["./kernel", "../on", "../has", "../dom-geometry"], function(a, k, h, n) {
                if (k._fixEvent) {
                    var c = k._fixEvent;
        ...
        "dojo/dom-geometry": function() {
            define(["./sniff", "./_base/window", "./dom", "./dom-style"], function(a, k, h, n) {
                ...
                g.getMarginBox = function(b, c) {
                    ...
                    if (a("mozilla")) {
                        ...
                        8 == a("ie") && !a("quirks")) && k && (k = n.getComputedStyle(k), f -= "none" != k.borderLeftStyle ? t(b, k.borderLeftWidth) : 0, m -= "none" != k.borderTopStyle ? t(b, k.borderTopWidth) : 0);
                    return {
                        l: f,
                        t: m,
                        w: b.offsetWidth + d.w,
        ...
        "dojo/_base/window": function() {
            define(["./kernel", "./lang", "../sniff"], function(a, k, h) {
                var n = {
                    global: a.global,
                    ...
                    withDoc: function(c, e, f, g) {
                        var m = n.doc,
                            ...
                            p, d, k;
                        try {
                            return a.doc = n.doc = c, a.isQuirks = h.add("quirks", "BackCompat" == a.doc.compatMode, !0, !0), h("ie") && (k = c.parentWindow) && k.navigator && (p = parseFloat(k.navigator.appVersion.split("MSIE ")[1]) || void 0, (d = c.documentMode) && 5 != d && Math.floor(p) != d && (p = d), a.isIE = h.add("ie", p, !0, !0)), f && "string" == typeof e &&
                            (e = f[e]), e.apply(f, g || [])
                        } finally {
            ...
            define(["./sniff", "./_base/window"], function(a, k) {
                ...
                a("ie") ? h.byId = function(a, e) {
                    ...
                    if (!g || g.attributes.id.value != a && g.id != a) {
                        ...
                        for (var m = 0; g = f[m++];)
                            if (g.attributes &&
                                g.attributes.id && g.attributes.id.value == a || g.id == a) return g
                    } else return g
                } : h.byId = function(a, e) {
                ...
                a.add("css-user-select", function(a, e, f) {
                    ...
                    var g = "userSelect";
                    do
                        if ("undefined" !== typeof a[g]) return g;
        ...
        "dojo/dom-style": function() {
            define(["./sniff", "./dom"], function(a, k) {
                ...
                n = a("webkit") ? function(b) {
                    ...
                    return 1 == b.nodeType ? b.ownerDocument.defaultView.getComputedStyle(b,
                        null) : {}
                };
                ...
                var f = function(b, a) {
                    ...
                    m = 9 > a("ie") || 10 > a("ie") && a("quirks") ? function(b, a) {
                        ...
                        if ("tr" == b.tagName.toLowerCase())
                            for (c = b.firstChild; c; c = c.nextSibling) "td" == c.tagName.toLowerCase() && m(c,
                                a);
                        return a
                    } : function(b, a) {
        ...
        "dojo/mouse": function() {
            define(["./_base/kernel", "./on", "./has", "./dom", "./_base/window"], function(a, k, h, n, c) {
                function e(a, c) {
                    var m = function(b, e) {
                ...
                h.add("dom-quirks",
                    c.doc && "BackCompat" == c.doc.compatMode);
        ...
        "dojo/_base/Deferred": function() {
            define("./kernel ../Deferred ../promise/Promise ../errors/CancelError ../has ./lang ../when".split(" "), function(a, k, h, n, c, e, f) {
                var g = function() {},
        ...
        "dojo/Deferred": function() {
            define(["./has", "./_base/lang", "./errors/CancelError", "./promise/Promise", "./promise/instrumentation"], function(a, k, h, n, c) {
        ...
        "dojo/promise/instrumentation": function() {
            define(["./tracer", "../has", "../_base/lang", "../_base/array"], function(a, k, h, n) {
                function c(b, a, c) {
        ...
        "dojo/promise/tracer": function() {
            define(["../_base/lang", "./Promise", "../Evented"], function(a, k, h) {
                function n(a) {
                    setTimeout(function() {
                        e.apply(c, a)
                    }, 0)
        ...
        "dojo/json": function() {
            define(["./has"], function(a) {
                ...
                var h = function(a) {
                    return ('"' + a.replace(/(["\\])/g, "\\$1") + '"').replace(/[\f]/g,
                    ...
                    stringify: function(a, c, e) {
                        function f(a, b, l) {
                            ...
                            if (a instanceof Array) {
                                var n = a.length,
                                    r = [];
                                for (l = 0; l < n; l++) k = f(a[l], d, l), "string" != typeof k &&
                                (k = "null"), r.push(q + d + k);
                                return "[" + r.join(",") + q + b + "]"
                            }
                            r = [];
        ...
        "dojo/_base/Color": function() {
            define(["./kernel", "./lang", "./array", "./config"], function(a, k, h, n) {
                ...
                k.extend(c, {
                    ...
                    setColor: function(a) {
                        k.isString(a) ? c.fromString(a, this) : k.isArray(a) ? c.fromArray(a, this) : (this._set(a.r,
                            a.g, a.b, a.a), a instanceof c || this.sanitize());
                        return this
                    },
                    sanitize: function() {
                        return this
                ...
                c.blendColors = a.blendColors = function(a,
                                                         f, g, m) {
                    var b = m || new c;
        ...
        "dojo/_base/unload": function() {
            define(["./kernel", "./lang", "../on"], function(a, k, h) {
                var n = window,
                    c = {
            ...
            define("exports ./sniff ./_base/lang ./dom ./dom-style ./dom-prop".split(" "),
                function(a, k, h, n, c, e) {
                    ...
                    a.get = function(a, c) {
                        ...
                        if ("href" !=
                            d && ("boolean" == typeof y || h.isFunction(y))) return y;
                        k = m[k] || c;
        ...
        "dojo/dom-prop": function() {
            define("exports ./_base/kernel ./sniff ./_base/lang ./dom ./dom-style ./dom-construct ./_base/connect".split(" "), function(a, k, h, n, c, e, f, g) {
                function m(a) {
                    var b = "";
                    a = a.childNodes;
        ...
        "dojo/dom-construct": function() {
            define("exports ./_base/kernel ./sniff ./_base/window ./dom ./dom-attr".split(" "), function(a, k, h, n, c, e) {
                function f(a, b) {
                    var c = b.parentNode;
        ...
        "dojo/dom-class": function() {
            define(["./_base/lang", "./_base/array", "./dom"], function(a, k, h) {
                function n(a) {
                    if ("string" == typeof a ||
                        a instanceof String) {
                ...
                return c = {
                    ...
                    add: function(a, b) {
                        ...
                        e < c.length && (a.className = c.substr(1,
                            c.length - 2))
                    },
                    remove: function(c, b) {
                        c = h.byId(c);
        ...
        "dojo/_base/NodeList": function() {
            define(["./kernel", "../query", "./array", "./html", "../NodeList-dom"], function(a, k, h) {
                k = k.NodeList;
                var n = k.prototype;
        ...
        "dojo/query": function() {
            define("./_base/kernel ./has ./dom ./on ./_base/array ./_base/lang ./selector/_loader ./selector/_loader!default".split(" "), function(a, k, h, n, c, e, f, g) {
                function m(a, b) {
                    var d = function(c, d) {
                ...
                d(["indexOf", "lastIndexOf", "every", "some"], function(b) {
                    var d = c[b];
                    t[b] = function() {
                        return d.apply(a, [this].concat(l.call(arguments,
                            0)))
                    }
                });
                e.extend(q, {
                ...
                function(a, k, h, n, c) {
                    var e = n.trim,
                        ...
                        l = function(a) {
                            ...
                            }, n = C), p ? t == p && (p = null) : "'" == t || '"' == t ? p = t : 0 <= d ? "]" == t ? (u.attr ? u.matchFor = b(g || d + 1, C) : u.attr = b(d + 1, C), !(d = u.matchFor) || '"' != d.charAt(0) && "'" != d.charAt(0) || (u.matchFor = d.slice(1, -1)), u.matchFor && (u.matchFor = u.matchFor.replace(/\\/g, "")), r.attrs.push(u), u = null, d = g = -1) : "\x3d" == t && (g = 0 <= "|~^$*".indexOf(E) ? E : "", u.type = g + t, u.attr = b(d + 1, C - g.length), g = C + 1) : 0 <= f ? ")" ==
                                t && (0 <= h && (u.value = b(f + 1, C)), h = f = -1) : "#" == t ? (x(), l = C + 1) : "." == t ? (x(), k = C) : ":" == t ? (x(), h = C) : "[" == t ? (x(), d = C, u = {}) : "(" == t ? (0 <= h && (u = {
                                name: b(h + 1, C),
                                value: null
                        ...
                        E = function(a) {
                            ...
                            e = -1;
                            for (b = b.firstElementChild || b.firstChild; b; b = b[x]) u(b) && (k("ie") ? b.setAttribute("_i",
                                ++c) : b._i = ++c, a === b && (e = c));
                            return e
                        },
                        C = function(a) {
                        ...
                        V = function(a, b) {
                            ...
                            var f = 0 <= "\x3e~+".indexOf(a.charAt(a.length -
                                1)) ? a + " *" : a;
                        ...
                        ca = function(a) {
                            ...
                            if (k("ie") && m) {
                                var e = M + "";
                                for (c = 0; c <
                                a.length; c++)(d = a[c]) && d.getAttribute("_zipIdx") != e && (b.push(d), d.setAttribute("_zipIdx", e))
        ...
        "dojo/NodeList-dom": function() {
            define("./_base/kernel ./query ./_base/array ./_base/lang ./dom-class ./dom-construct ./dom-geometry ./dom-attr ./dom-style".split(" "), function(a, k, h, n, c, e, f, g, m) {
                function b(a) {
                    return function(b, c, d) {
        ...
        "dojo/_base/xhr": function() {
            define("./kernel ./sniff require ../io-query ../dom ../dom-form ./Deferred ./config ./json ./lang ./array ../on ../aspect ../request/watch ../request/xhr ../request/util".split(" "), function(a, k, h, n, c, e, f,
                                                                                                                                                                                                            g, m, b, l, p, d, y, q, r) {
                a._xhrObj = q._create;
                var t = a.config;
                ...
                a._ioNotifyStart = function(b) {
                    t.ioPublish &&
                    a.publish && !1 !== b.ioArgs.args.ioPublish && (w || a.publish("/dojo/io/start"), w += 1, a.publish("/dojo/io/send", [b]))
                };
        ...
        "dojo/dom-form": function() {
            define(["./_base/lang", "./dom", "./io-query", "./json"], function(a, k, h, n) {
                var c = {
        ...
        "dojo/request/watch": function() {
            define("./util ../errors/RequestTimeoutError ../errors/CancelError ../_base/array ../_base/window ../has!host-browser?dom-addeventlistener?:../on:".split(" "), function(a, k, h, n, c, e) {
                function f() {
        ...
        "dojo/request/util": function() {
            define("exports ../errors/RequestError ../errors/CancelError ../Deferred ../io-query ../_base/array ../_base/lang ../promise/Promise".split(" "), function(a,
                                                                                                                                                                       k, h, n, c, e, f, g) {
                function m(a) {
                    return l(a)
                }
                ...
                a.addCommonMethods = function(a, b) {
                    e.forEach(b || ["GET", "POST", "PUT", "DELETE"],
                        function(b) {
        ...
        "dojo/request/xhr": function() {
            define(["../errors/RequestError", "./watch", "./handlers", "./util", "../has"], function(a, k, h, n, c) {
                function e(b,
                           c) {
                    var d = b.xhr;
                ...
                function g(h, t, x) {
                    ...
                    try {
                        ...
                        h &&
                        !1 !== h && E.setRequestHeader("Content-Type", h);
        ...
        "dojo/_base/fx": function() {
            define("./kernel ./config ./lang ../Evented ./Color ../aspect ../sniff ../dom ../dom-style".split(" "), function(a, k, h, n, c, e, f, g, m) {
                var b = h.mixin,
                    l = {},
                ...
                h.extend(d, {
                    ...
                    play: function(a, b) {
                        ...
                        if (0 < c) return this._delayTimer = setTimeout(d,
                            c), this;
                        d();
                        return this
                    },
                ...
                var t = f("ie") ? function(a) {
                    var b = a.style;
                    b.width.length ||
                    "auto" != m.get(a, "width") || (b.width = "auto")
                } : function() {};
                l._fade = function(a) {
                ...
                l.animateProperty = function(f) {
                    ...
                    e.after(f, "beforeBegin", h.hitch(f, function() {
                        ...
                        for (d in this.properties) {
                            ...
                            g ? (f.start = new c(f.start), f.end = new c(f.end)) :
                                f.start = "opacity" == d ? +f.start : parseFloat(f.start)
                        }
                        this.curve = new x(a)
                    }), !0);
        ...
        "dojo/_base/loader": function() {
            define("./kernel ../has require module ../json ./lang ./array".split(" "), function(a, k, h, n, c, e, f) {
                var g = function(a) {
                        return a.replace(/\./g, "/")
                    },
                    m = /\/\/>>built/,
                    ...
                    y = function(b, c, d) {
                        ...
                        if (0 != f) throw "unmatched paren around character " +
                        e.lastIndex + " in: " + b;
                    ...
                    x = function(a, b) {
                        ...
                        }); c = r.exec(b);) d = r.lastIndex, e = d - c[0].length, d = y(b, d, e), "loadInit" == c[2] ? f.push(d[0]) : g.push(d[0]), r.lastIndex =
                            d[1];
                        c = f.concat(g);
                ...
                a.require = function(a, b) {
                    ...
                    k("config-publishRequireResult") && !e.exists(a) && void 0 !== c && e.setObject(a,
                        c);
                    return c
                };
                ...
                a.platformRequire = function(b) {
                    ...
                    for (var c; b.length;) e.isArray(c = b.shift()) ? a.require.apply(a, c) : a.require(c)
                };
...
require({
    cache: {
        ...
        "dijit/_base/manager": function() {
            define(["dojo/_base/array", "dojo/_base/config", "dojo/_base/lang", "../registry", "../main"], function(a, k, h, n, c) {
                var e = {};
        ...
        "dijit/registry": function() {
            define(["dojo/_base/array", "dojo/_base/window", "./main"], function(a,
                                                                                 k, h) {
                var n = {},
                    c = {},
                    e = {
        ...
        "dojo/parser": function() {
            define("require ./_base/kernel ./_base/lang ./_base/array ./_base/config ./dom ./_base/window ./_base/url ./aspect ./promise/all ./date/stamp ./Deferred ./has ./query ./on ./ready".split(" "), function(a, k, h, n, c, e, f, g, m, b, l, p, d, y, q, r) {
                function t(a) {
                    return eval("(" + a + ")")
                }
                ...
                var z = {},
                    w = {
                        ...
                        _functionFromScript: function(a,
                                                      b) {
                            var c = "",
                                d = "",
                        ...
                        construct: function(a,
                            ...
                            p = "data-" + F + "-";
                            var A = {};
                            "dojo" !== F && (A[p + "props"] = "data-dojo-props", A[p + "type"] = "data-dojo-type", A[p + "mixins"] = "data-dojo-mixins", A[F + "type"] =
                                "dojoType", A[p + "id"] = "data-dojo-id");
                            ...
                            var G = [],
                                ...
                                M = [];
                            if (f)
                                for (D = 0; D < f.length; D++) A = f[D], b.removeChild(A), c = A.getAttribute(p + "event") || A.getAttribute("event"), e = A.getAttribute(p + "prop"), K = A.getAttribute(p + "method"), F = A.getAttribute(p + "advice"),
                                    w = A.getAttribute("type"), A = this._functionFromScript(A, p), c ? "dojo/connect" == w ? G.push({
                                    method: c,
                                    func: A
                                }) : "dojo/on" == w ? M.push({
                                    event: c,
                        ...
                        for (var a = arguments, e = [a[0]], f = 1; f < a.length; f++)
                            if (a[f]) {
                                ...
                                if ("" == g.path && !g.scheme && !g.authority && !g.query) null != g.fragment && (e.fragment = g.fragment), g = e;
                                    ...
                                    for (var e =
                                        (e.path.substring(0, e.path.lastIndexOf("/") + 1) + g.path).split("/"), m = 0; m < e.length; m++) "." == e[m] ? m == e.length - 1 ? e[m] = "" : (e.splice(m, 1), m--) : 0 < m && (1 != m || "" != e[0]) && ".." == e[m] && ".." != e[m - 1] && (m == e.length - 1 ? (e.splice(m, 1), e[m - 1] = "") : (e.splice(m - 1, 2), m -= 2));
                                    g.path = e.join("/")
                                }
                                e = [];
        ...
        "dojo/promise/all": function() {
            define(["../_base/array", "../Deferred", "../when"], function(a, k, h) {
                var n = a.some;
                return function(a) {
                    var e, f;
        ...
        "dojo/request/script": function() {
            define("module ./watch ./util ../_base/kernel ../_base/array ../_base/lang ../on ../dom ../dom-construct ../has ../_base/window".split(" "), function(a, k, h, n, c, e, f, g, m, b, l) {
                function p(a, b) {
                        ...
                        a.get(h, {
                            ...
                            if ("error" != a.result)
                                if ("dev" === e) f._setupPopupSignupForm(a, n, c, e);
                                    ...
                                    require([h + a.version + "/popup.js"], function() {
                                        f._setupPopupSignupForm(a, n, c, e)
                                    })
                                }
                        })
                    },
                    _getFormSettingsUrl: function(a,
                                                  h, n) {
